...
class RegistrationCreateSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        if Registration.objects.filter(ticket_id=ticket_id, user_id=user_id).exists():
            raise serializers.ValidationError("User is already registered for this ticket.")
...
class RegistrationListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Registration
        fields = [
            'id', 'ticket', 'user', 'event', 'created_at', 'updated_at'
        ]
    ...
    def get_event(self, obj):
        return {
            'id': str(obj.ticket.event.id),
            'name': obj.ticket.event.name
        }

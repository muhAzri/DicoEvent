...
from .serializers import TicketCreateSerializer, TicketListSerializer, TicketDetailSerializer, TicketUpdateSerializer
...
class TicketsView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            return Response(serializer.to_representation(ticket), status=status.HTTP_201_CREATED)
